...
install:
	...
	install -Dm644 config/01_datasource_list.cfg "$(DESTDIR)/etc/cloud/cloud.cfg.d/01_datasource_list.cfg"
	...
	install -Dm644 config/init.arch.local "$(DESTDIR)/$(PREFIX)/share/cloud-init-extra/init.arch.local.default"
